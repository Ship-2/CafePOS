...
public class EmployeeResultView {
	...
	public void displayDmlResult(String dmlResultCode) {
		...
		case "selectSuccess":
			System.out.println("[Success] 직원 조회 성공."); break;
		case "selectFailed":
			System.out.println("[error] 직원 조회 실패."); break;
		case "insertSuccess":
			System.out.println("[Success] 직원 추가 성공."); break;
		case "insertFailed":
			System.out.println("[error] 직원 추가 실패."); break;
		case "deleteSuccess":
			System.out.println("[Success] 직원 삭제 성공."); break;
		case "deleteFailed":
			System.out.println("[error] 직원 삭제 실패."); break;
		case "updateSuccess":
			System.out.println("[Success] 직원 수정 성공."); break;
		case "updateFailed":
			System.out.println("[error] 직원 수정 실패."); break;
