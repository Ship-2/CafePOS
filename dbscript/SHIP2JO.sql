...
INSERT 
  INTO MENU
(
MENU_CODE, MENU_NAME, UNIT_PRICE, CATEGORY_CODE, SIZE_CODE
) 
VALUES
(
SEQ_MENU_CODE.NEXTVAL, '아메리카노', 3500, 1, 1
);
...
VALUES
(
SEQ_MENU_CODE.NEXTVAL, '아메리카노', 4000, 1, 2
);
...
VALUES
(
SEQ_MENU_CODE.NEXTVAL, '바닐라라떼', 4500, 1, 1
);
...
VALUES
(
SEQ_MENU_CODE.NEXTVAL, '바닐라라떼', 5000, 1, 2
);
...
VALUES
(
SEQ_MENU_CODE.NEXTVAL, '레몬에이드', 4500, 2, 1
);
...
VALUES
(
SEQ_MENU_CODE.NEXTVAL, '레몬에이드', 5000, 2, 2
);
...
VALUES
(
SEQ_MENU_CODE.NEXTVAL, '플레인요거트스무디', 4500, 2, 1
);
...
VALUES
(
SEQ_MENU_CODE.NEXTVAL, '플레인요거트스무디', 5000, 2, 2
);
...
VALUES
(
SEQ_MENU_CODE.NEXTVAL, '초코크로플', 2000, 3, 3
);
...
VALUES
(
SEQ_MENU_CODE.NEXTVAL, '크로아상', 3000, 3, 3
);
...
VALUES
(
SEQ_MENU_CODE.NEXTVAL, '베이글', 2500, 3, 3
);
